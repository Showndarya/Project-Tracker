...
INSERT INTO `issue` (`issue_id`, `emp_id`, `project_id`, `issue_name`, `issue_desc`, `cat_id`, `status`, `assign`) VALUES
(1, 1, 1, 'issue1', 'this is an issue', 1, 'Closed', 1),
(2, 1, 1, 'issue2', 'this is an issue2', 3, 'In Progress', 0),
(9, 1, 1, 'issue3', 'this is an issue3', 5, 'Open', 1),
(10, 1, 2, 'issue4', 'First issue in project 2', 0, 'Open', 0);
...
(2, 'PROJ2', 'The project is P2. The admin of the project is domain_admin1.', '01/01/2017', '03/03/2017', 'Mumbai', 10000, 'Client2'),
